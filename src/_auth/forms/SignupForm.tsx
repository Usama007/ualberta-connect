  ...
  return (
    <Form {...form}>
      <div className="sm:w-420 flex-center flex-col">
        ...
        <h2 className="h3-bold md:h2-bold pt-5 sm:pt-12 text-dark-4">
          Create a new account
        </h2>
        <p className="text-light-3 small-medium md:base-regular mt-2">
          To use Ualberta Connect, Please enter your details
        </p>
        <form
          ...
          <Button type="submit" className="shad-button_green">
          ...
          <p className="text-small-regular text-dark-2 text-center mt-2">
            ...
            <Link
              to="/sign-in"
              className="text-dark-2 font-bold ml-1">
              Log in
            </Link>
          </p>
        </form>
